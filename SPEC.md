...
### First surcharge band for ordinary income

Support rounded taxable total income after employer NPS up to ₹1 crore when no positive short-term or long-term equity gains remain after permitted loss set-off. At exactly ₹50 lakh there is no surcharge. Above ₹50 lakh through ₹1 crore, apply 10% surcharge to ordinary income tax after rebate/relief. Reduce surcharge by any excess of tax plus surcharge over tax on ₹50 lakh plus the income exceeding ₹50 lakh, capped at the surcharge. Compute the ₹50 lakh comparison using the existing ordinary slab function; do not hard-code a marginal-relief end point. Keep this surcharge marginal relief separate from the existing rebate-related marginal relief near ₹12 lakh.

Apply cess to income tax plus surcharge after surcharge marginal relief, then apply actual credits/payments and final rounding once. The threshold and ceiling use rounded taxable income after employer NPS; annual-return income tests remain before NPS. Preserve all presumptive receipt/profit, age, residence, new-regime, audit, foreign-income and credit conditions. Positive equity gains remaining after loss set-off still cap this version at ₹50 lakh pending a sourced mixed-rate surcharge comparison. Pure losses or fully offset gains do not block the ordinary-income branch. Income above ₹1 crore remains unsupported.
...
The Application calculates no surcharge beyond this first ordinary-income band, deduction other than the supported salary, employer NPS and rental deductions, losses outside the domestic equity branch, special-rate tax other than the domestic equity branch, foreign-tax relief, interest, fee, or penalty.
...
- Regular-books cases, old tax regime, audit cases, surcharge outside the supported ordinary-income band, taxable total income above ₹1 crore, and positive equity gains with taxable total income above ₹50 lakh.
