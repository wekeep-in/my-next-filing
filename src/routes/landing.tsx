        ...
        <section className="landing" aria-labelledby="landing-title">
            <header className="landing-hero">
                ...
                <p className="landing-intro">
                    Estimate your taxes and see the next filing dates. It
            ...
            <section className="landing-faqs" id="faqs" aria-labelledby="faqs-title">
                ...
                <div className="faq-list">
                    ...
                    <article>
                        ...
                        <p>
                            <ExternalLink href="https://sarthakmishra.com/">Sarthak Mishra</ExternalLink> operates My Next Filing. For access, correction,
